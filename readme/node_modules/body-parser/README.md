...
[![NPM Version](https://badgen.net/npm/v/body-parser)](https://npmjs.org/package/body-parser) [![NPM Downloads](https://badgen.net/npm/dm/body-parser)](https://npmjs.org/package/body-parser) [![Build Status](https://badgen.net/github/checks/expressjs/body-parser/master?label=ci)](https://github.com/expressjs/body-parser/actions/workflows/ci.yml) [![Test Coverage](https://badgen.net/coveralls/c/github/expressjs/body-parser/master)](https://coveralls.io/r/expressjs/body-parser?branch=master) [![OpenSSF Scorecard Badge](https://api.scorecard.dev/projects/github.com/expressjs/body-parser/badge)](https://ossf.github.io/scorecard-visualizer/#/projects/github.com/expressjs/body-parser)
...
[MIT](../../../node_modules/body-parser/LICENSE/)
