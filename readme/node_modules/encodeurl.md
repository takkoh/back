...
As a result, the encoding aligns closely with the behavior in the [WHATWG URL specification](https://url.spec.whatwg.org/). However, this package only encodes strings and does not do any URL parsing or formatting.
...
[MIT](../../node_modules/encodeurl/LICENSE/)
